...
class Url(atom.AtomBase):
  _tag = 'url'
  _namespace = GWEBMASTERTOOLS_NAMESPACE
  
class Detail(atom.AtomBase):
  _tag = 'detail'
  _namespace = GWEBMASTERTOOLS_NAMESPACE

class IssueType(atom.AtomBase):
  _tag = 'issue-type'
  _namespace = GWEBMASTERTOOLS_NAMESPACE
  
class DateDetected(atom.AtomBase):
  _tag = 'date-detected'
  _namespace = GWEBMASTERTOOLS_NAMESPACE

class CrawlIssueEntry(atom.Entry, LinkFinder):
  """A Google Webmaster Tools meta Entry flavor of an Atom Entry """
  ...
  _children['{%s}entryLink' % gdata.GDATA_NAMESPACE] = (
      'entry_link', [gdata.EntryLink])
  _children['{%s}url' % GWEBMASTERTOOLS_NAMESPACE] = ('url', Url)
  _children['{%s}detail' % GWEBMASTERTOOLS_NAMESPACE] = ('detail', Detail)
  _children['{%s}issue-type' % GWEBMASTERTOOLS_NAMESPACE] = ('issuetype', IssueType)
  _children['{%s}date-detected' % GWEBMASTERTOOLS_NAMESPACE] = ('datedetected', DateDetected)
  ...
  def __init__(self, category=None, content=None,
      atom_id=None, link=None, title=None, updated=None,
      extension_elements=None, extension_attributes=None, text=None, 
      url=None, detail=None, issuetype=None, datedetected=None):
    atom.Entry.__init__(self, category=category, 
                        content=content, atom_id=atom_id, link=link, 
                        title=title, updated=updated, text=text)
...
def CrawlIssueEntryFromString(xml_string):
  return atom.CreateClassFromXMLString(CrawlIssueEntry, xml_string)
  

class CrawlIssueFeed(atom.Feed, LinkFinder):
  """A Google Webmaster Tools meta Sitemaps feed flavor of an Atom Feed"""
  ...
  _children = atom.Feed._children.copy()
  _attributes = atom.Feed._attributes.copy()
  _children['{%s}entry' % atom.ATOM_NAMESPACE] = ('entry', [CrawlIssueEntry])
  _children['{%s}startIndex' % gdata.OPENSEARCH_NAMESPACE] = (
      'start_index', gdata.StartIndex)
  _children['{%s}totalResults' % gdata.OPENSEARCH_NAMESPACE] = (
      'total_results', gdata.TotalResults)
  ...
  def __init__(self, category=None, content=None,
      atom_id=None, link=None, title=None, updated=None,
      entry=None, extension_elements=None, extension_attributes=None, text=None):
...
def CrawlIssueFeedFromString(xml_string):
  return atom.CreateClassFromXMLString(CrawlIssueFeed, xml_string)
